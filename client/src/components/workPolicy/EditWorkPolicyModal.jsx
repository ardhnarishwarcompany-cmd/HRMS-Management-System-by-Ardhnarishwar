...
export default function EditWorkPolicyModal({ open, onClose, policy, form, setForm, onSubmit, departmentOptions, policyTypeOptions }) {
  const handleChange = (field, value) => {
    setForm((prev) => ({ ...prev, [field]: value }));
  };

  return (
    <Modal open={open} onClose={onClose} title="Edit Work Policy" size="lg">
