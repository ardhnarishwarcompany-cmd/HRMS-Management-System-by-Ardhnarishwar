      ...
      <div className="relative overflow-hidden rounded-3xl bg-slate-900 px-8 py-9 md:px-12">
        ...
        <div className="relative">
          ...
          <p className="mt-2 max-w-xl text-sm leading-relaxed text-slate-400">
            {isEmployee ? "Raise a complaint and track the client response." : "View employee complaints and respond from the client portal."}
          </p>
        </div>
      </div>

      {/* ── NEW COMPLAINT FORM ────────────────────────────── */}
      {isEmployee && <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        {isEmployee && <form onSubmit={handleSubmit} className="space-y-5 p-6">
