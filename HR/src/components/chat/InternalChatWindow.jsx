  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await axios.post(
        ...
        { room, recipientId: activeChat?.recipientId, message: text.trim(), senderType: myType },
        { headers: { Authorization: `Bearer ${token}` } },
      );
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="h-16 flex items-center px-5 border-b bg-white gap-3 shrink-0">
        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-indigo-500 to-violet-500 flex items-center justify-center text-white font-bold">
