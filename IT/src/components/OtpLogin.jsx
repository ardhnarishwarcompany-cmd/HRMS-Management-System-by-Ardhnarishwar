...
export default function OtpLogin({ portal, onSuccess, variant = "glass" }) {
  ...
  const inputCls = glass
    ? "w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-sm text-white placeholder-white/25 outline-none transition-all duration-300 focus:border-fuchsia-400/60 focus:bg-black/60 focus:shadow-[0_0_0_3px_rgba(217,70,239,0.15),0_8px_30px_-10px_rgba(217,70,239,0.4)]"
  ...
  const btnCls = glass
    ? "w-full rounded-xl bg-gradient-to-r from-violet-500 via-fuchsia-500 to-indigo-600 py-3 text-sm font-bold text-white shadow-[0_0_35px_rgba(217,70,239,0.45)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_55px_rgba(217,70,239,0.65)] disabled:cursor-not-allowed disabled:opacity-60"
