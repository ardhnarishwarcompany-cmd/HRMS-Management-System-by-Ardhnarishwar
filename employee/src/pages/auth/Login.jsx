...
/* ═══════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════ */
const CONTENT = {
  badge: "HRMS Employee Workspace",
  headlineTop: "Your workday,",
  headlineGradient: "organised and on track.",
  subtext:
    "Attendance, tasks, targets, leave and payslips — everything you need for the day in one secure, role-based HRMS workspace.",
  marquee: [
    "One-tap attendance",
    "Tasks & EOD reports",
    "Targets & performance",
  ...
  return (
    ...
    >
      ...
      <header className="lx-rise relative z-10 flex shrink-0 items-center justify-between px-5 py-4 sm:px-8 lg:px-12">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-none">
            <span className="block text-lg font-bold tracking-wide">Employee Portal</span>
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col items-center justify-center gap-10 px-5 py-6 sm:px-8 lg:min-h-0 lg:flex-row lg:gap-12 lg:px-12 lg:py-2 xl:gap-20">
        ...
        <MagicCard className="w-full max-w-md">
          <div className="p-5 sm:p-7">
            ...
            <p className="mt-1 text-sm text-white/45">Sign in to start your workday.</p>
            ...
            <div className="mt-5">
              {mode === "otp" ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  <div>
                    <label htmlFor="emp-email" className={LABEL_CLASS}>Email address</label>
                  ...
                  <div>
                    <label htmlFor="emp-password" className={LABEL_CLASS}>Password</label>
                    <div className="group relative">
                      <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-white/25 transition-colors duration-300 group-focus-within:text-fuchsia-300">
                        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
                          <rect x="4" y="10" width="16" height="11" rx="2" />
            ...
            <p className="mt-5 text-center text-xs text-white/30">Trouble signing in? Contact your HR administrator.</p>
          </div>
        </MagicCard>
      </main>
      ...
      <footer className="relative z-10 shrink-0 border-t border-white/[0.06] py-3">
        ...
        <p className="sr-only">One-tap attendance, tasks and EOD reports, targets and performance, leave management, payslips and compensation, role-based security</p>
      </footer>
    </div>
  );
}
