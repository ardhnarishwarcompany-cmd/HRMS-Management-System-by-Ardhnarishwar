...
/* ═══════════════ Hero Scene — living employee workday ═══════════════ */
const SCENE = {
  stages: [
    { n: "Attend.", v: 48 },
    { n: "Tasks", v: 39 },
  ...
  bars: [70, 85, 80, 95, 88, 60, 30],
  tasks: ["Submit EOD report", "Team standup · 11:00", "Review Q3 goals"],
};
    ...
    >
      ...
      <div className="lx-anim absolute left-1/2 top-1/2 flex w-[60%] -translate-x-1/2 -translate-y-[62%] flex-col items-center" style={{ animation: "floatY 7s ease-in-out infinite" }}>
        ...
        >
          <div className="flex items-center justify-between">
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/50">My workday</p>
          ...
          <div className="mt-2.5 flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-[9px] font-bold uppercase tracking-[0.18em] text-white/40">Weekly hours</p>
      ...
      >
        ...
        <div className="leading-tight">
          <p className="text-[11px] font-semibold text-white">Checked in · 09:02 AM</p>
          <p className="text-[9px] text-white/45">On time · Head office</p>
        </div>
      </div>
      ...
      >
        <p className="text-[9px] font-bold uppercase tracking-[0.18em] text-white/45">Today&apos;s tasks</p>
      ...
      >
        <div className="flex items-center justify-between">
          <p className="text-[9px] font-bold uppercase tracking-[0.18em] text-white/45">Leave balance</p>
          <span className="text-[9px] font-bold text-emerald-300">Available</span>
        </div>
        <p className="mt-1 text-base font-black text-white">14 days</p>
      ...
      >
        ...
        <div className="leading-tight">
          <p className="text-[11px] font-semibold text-white">Payslip generated</p>
